        ...
        {open && (
          <motion.div
            ...
            <div style={{ background: G.gold, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '12px', fontWeight: 900, color: G.bg, lineHeight: 1 }}>Gizem Hoca AI</div>
                <div style={{ fontSize: '9px', color: 'rgba(13,27,62,0.55)', marginTop: '2px' }}>
              ...
              <>
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {msgs.map((msg, i) => (
                    <div key={i} style={{ display: 'flex', justifyContent: msg.role === 'user' ? 'flex-end' : 'flex-start' }}>
                      <div style={{
                        maxWidth: '88%', padding: '9px 12px', fontSize: '12px', lineHeight: 1.55,
                  ...
                  <div style={{ padding: '0 12px 8px', display: 'flex', flexWrap: 'wrap', gap: '5px' }}>
                    {quickQuestions.map((q, i) => (
                      <button key={i} onClick={() => sendMsg(q)}
                        style={{ fontSize: '10px', padding: '4px 10px', borderRadius: '999px', background: 'rgba(212,175,55,0.1)', border: `1px solid ${G.goldBorder}`, color: G.gold, cursor: 'pointer', fontFamily: 'Montserrat', fontWeight: 600, transition: 'all 0.15s' }}
                ...
                <div style={{ padding: '0 12px 8px' }}>
                  <a href={`https://wa.me/${WA}`} target="_blank" rel="noopener noreferrer"
                    style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '10px', fontWeight: 700, color: '#25d366', textDecoration: 'none', opacity: 0.8, transition: 'opacity 0.2s' }}
