...
export default function BeforeAfterSlider({ before, after, beforeLabel = 'ÖNCE', afterLabel = 'SONRA' }) {
  ...
  return (
    <div ref={containerRef}
      ...
      <div style={{ position: 'absolute', top: '12px', right: '14px', background: 'rgba(212,175,55,0.9)', color: '#0d1b3e', fontSize: '9px', fontWeight: 900, padding: '4px 10px', borderRadius: '999px', letterSpacing: '0.1em' }}>{afterLabel}</div>
      ...
      <div style={{ position: 'absolute', inset: 0, width: `${pos}%`, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: '12px', left: '14px', background: 'rgba(255,255,255,0.2)', backdropFilter: 'blur(4px)', border: '1px solid rgba(255,255,255,0.3)', color: '#fff', fontSize: '9px', fontWeight: 900, padding: '4px 10px', borderRadius: '999px', letterSpacing: '0.1em' }}>{beforeLabel}</div>
      </div>
